...
function cmi1(){
        ...
        document.getElementById("cmi2").style.backgroundColor = "#fff";
        document.getElementById("cmi2").style.color = "#000";
        document.getElementById("cmi3").style.backgroundColor = "#fff";
        document.getElementById("cmi3").style.color = "#000";
        document.getElementById("cmi4").style.backgroundColor = "#fff";
        document.getElementById("cmi4").style.color = "#000";
        document.getElementById("cmi4").style.backgroundColor = "#fff";
        document.getElementById("cmi4").style.color = "#000";
        document.getElementById("cmi5").style.backgroundColor = "#fff";
        document.getElementById("cmi5").style.color = "#000";
        document.getElementById("cmi6").style.backgroundColor = "#fff";
        document.getElementById("cmi6").style.color = "#000";
        document.getElementById("cmi7").style.backgroundColor = "#fff";
        document.getElementById("cmi7").style.color = "#000";
        document.getElementById("cmi8").style.backgroundColor = "#fff";
        document.getElementById("cmi8").style.color = "#000";
        document.getElementById("cmi9").style.backgroundColor = "#fff";
        document.getElementById("cmi9").style.color = "#000";
        document.getElementById("cmi10").style.backgroundColor = "#fff";
        document.getElementById("cmi10").style.color = "#000";
        document.getElementById("cmi11").style.backgroundColor = "#fff";
        document.getElementById("cmi11").style.color = "#000";
        document.getElementById("cmi12").style.backgroundColor = "#fff";
        document.getElementById("cmi12").style.color = "#000";
    ...
    function cmi2(){
        document.getElementById("cmi1").style.backgroundColor = "#fff";
        document.getElementById("cmi1").style.color = "#000";
        document.getElementById("cmi2").style.backgroundColor = "#000";
        document.getElementById("cmi2").style.color = "#fff";
        document.getElementById("cmi3").style.backgroundColor = "#fff";
        document.getElementById("cmi3").style.color = "#000";
        document.getElementById("cmi4").style.backgroundColor = "#fff";
        document.getElementById("cmi4").style.color = "#000";
     ...
     function cmi3(){
        ...
        document.getElementById("cmi2").style.backgroundColor = "#fff";
        document.getElementById("cmi2").style.color = "#000";
        document.getElementById("cmi3").style.backgroundColor = "#000";
        document.getElementById("cmi3").style.color = "#fff";
        document.getElementById("cmi4").style.backgroundColor = "#fff";
        document.getElementById("cmi4").style.color = "#000";
        document.getElementById("cmi4").style.backgroundColor = "#fff";
        document.getElementById("cmi4").style.color = "#000";
     ...
     function cmi4(){
        ...
        document.getElementById("cmi4").style.backgroundColor = "#fff";
        document.getElementById("cmi4").style.color = "#000";
        document.getElementById("cmi4").style.backgroundColor = "#000";
        document.getElementById("cmi4").style.color = "#fff";
        document.getElementById("cmi5").style.backgroundColor = "#fff";
        document.getElementById("cmi5").style.color = "#000";
        document.getElementById("cmi6").style.backgroundColor = "#fff";
        document.getElementById("cmi6").style.color = "#000";
    ...
    function cmi5(){
        ...
        document.getElementById("cmi4").style.backgroundColor = "#fff";
        document.getElementById("cmi4").style.color = "#000";
        document.getElementById("cmi5").style.backgroundColor = "#000";
        document.getElementById("cmi5").style.color = "#fff";
        document.getElementById("cmi6").style.backgroundColor = "#fff";
        document.getElementById("cmi6").style.color = "#000";
        document.getElementById("cmi7").style.backgroundColor = "#fff";
        document.getElementById("cmi7").style.color = "#000";
    ...
    function cmi6(){
        ...
        document.getElementById("cmi5").style.backgroundColor = "#fff";
        document.getElementById("cmi5").style.color = "#000";
        document.getElementById("cmi6").style.backgroundColor = "#000";
        document.getElementById("cmi6").style.color = "#fff";
        document.getElementById("cmi7").style.backgroundColor = "#fff";
        document.getElementById("cmi7").style.color = "#000";
        document.getElementById("cmi8").style.backgroundColor = "#fff";
        document.getElementById("cmi8").style.color = "#000";
    ...
    function cmi7(){
        ...
        document.getElementById("cmi6").style.backgroundColor = "#fff";
        document.getElementById("cmi6").style.color = "#000";
        document.getElementById("cmi7").style.backgroundColor = "#000";
        document.getElementById("cmi7").style.color = "#fff";
        document.getElementById("cmi8").style.backgroundColor = "#fff";
        document.getElementById("cmi8").style.color = "#000";
        document.getElementById("cmi9").style.backgroundColor = "#fff";
        document.getElementById("cmi9").style.color = "#000";
    ...
    function cmi8(){
        ...
        document.getElementById("cmi7").style.backgroundColor = "#fff";
        document.getElementById("cmi7").style.color = "#000";
        document.getElementById("cmi8").style.backgroundColor = "#000";
        document.getElementById("cmi8").style.color = "#fff";
        document.getElementById("cmi9").style.backgroundColor = "#fff";
        document.getElementById("cmi9").style.color = "#000";
        document.getElementById("cmi10").style.backgroundColor = "#fff";
        document.getElementById("cmi10").style.color = "#000";
    ...
    function cmi9(){
        ...
        document.getElementById("cmi8").style.backgroundColor = "#fff";
        document.getElementById("cmi8").style.color = "#000";
        document.getElementById("cmi9").style.backgroundColor = "#000";
        document.getElementById("cmi9").style.color = "#fff";
        document.getElementById("cmi10").style.backgroundColor = "#fff";
        document.getElementById("cmi10").style.color = "#000";
        document.getElementById("cmi11").style.backgroundColor = "#fff";
        document.getElementById("cmi11").style.color = "#000";
        ...
        document.getElementById("opt7").style.display = "none";
        document.getElementById("opt8").style.display = "none";
        document.getElementById("opt9").style.display = "block";
        document.getElementById("opt10").style.display = "none";
        document.getElementById("opt11").style.display = "none";
        document.getElementById("opt12").style.display = "none";
    }
    function cmi10(){
        ...
        document.getElementById("cmi9").style.backgroundColor = "#fff";
        document.getElementById("cmi9").style.color = "#000";
        document.getElementById("cmi10").style.backgroundColor = "#000";
        document.getElementById("cmi10").style.color = "#fff";
        document.getElementById("cmi11").style.backgroundColor = "#fff";
        document.getElementById("cmi11").style.color = "#000";
        document.getElementById("cmi12").style.backgroundColor = "#fff";
        document.getElementById("cmi12").style.color = "#000";
    ...
    function cmi11(){
        ...
        document.getElementById("cmi10").style.backgroundColor = "#fff";
        document.getElementById("cmi10").style.color = "#000";
        document.getElementById("cmi11").style.backgroundColor = "#000";
        document.getElementById("cmi11").style.color = "#fff";
        document.getElementById("cmi12").style.backgroundColor = "#fff";
        document.getElementById("cmi12").style.color = "#000";
        document.getElementById("opt1").style.display = "none";
        document.getElementById("opt2").style.display = "none";
    ...
    function cmi12(){
        ...
        document.getElementById("cmi11").style.backgroundColor = "#fff";
        document.getElementById("cmi11").style.color = "#000";
        document.getElementById("cmi12").style.backgroundColor = "#000";
    }
var 메시지다이제스트알고리즘 = function (string) {
